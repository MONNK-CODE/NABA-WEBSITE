...
function render() {
    ...
    let remaining = diff;
    const d = Math.floor(remaining / (1000 * 60 * 60 * 24)); remaining %= (1000 * 60 * 60 * 24);
    const h = Math.floor(remaining / (1000 * 60 * 60));    remaining %= (1000 * 60 * 60);
    const m = Math.floor(remaining / (1000 * 60));       remaining %= (1000 * 60);
